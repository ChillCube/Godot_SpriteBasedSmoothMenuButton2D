# Godot_SpriteBasedSmoothMenuButton2D
...
## Documentation
You can find the documentation at: https://github.com/ChillCube/Godot_SpriteBasedSmoothMenuButton2D/blob/main/DOCUMENTATION.md

## Deinstallation
### Linux
Run this in the root of your godot project:
```bash
remove-gd-addon Godot_SpriteBasedSmoothMenuButton2D
```
